...
tf.app.flags.DEFINE_string('source_vocabulary', 'wordlist.json', 'Path to source vocabulary')
tf.app.flags.DEFINE_string('target_vocabulary', 'wordlist.json', 'Path to target vocabulary')
tf.app.flags.DEFINE_string('source_train_data', 'newkey.txt', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'newvalue.txt', 'Path to target training data')
...
tf.app.flags.DEFINE_integer('num_encoder_symbols', 4300, 'Source vocabulary size')
tf.app.flags.DEFINE_integer('num_decoder_symbols', 4300, 'Target vocabulary size')
