...
class Seq2SeqModel(object):
    ...
    def __init__(self, config, mode):
	    ...
	    tf.assign(self.global_epoch_step, self.global_epoch_step+1) #把A的值变成B
    ...
    def init_placeholders(self):       
        ...
        self.batch_size = tf.shape(self.encoder_inputs)[0] #获取输入数据的数量
        if self.mode == 'train':
    ...
    def build_decoder(self):
        ...
        with tf.variable_scope('decoder'):
            ...
            # Input projection layer to feed embedded inputs to the cell
            # ** Essential when use_residual=True to match input/output dims
            input_layer = Dense(self.hidden_units, dtype=self.dtype, name='input_projection') #全连接，实现维度变换
    ...
    def train(self, sess, encoder_inputs, encoder_inputs_length, 
        ...
        #print(encoder_inputs,encoder_inputs_length, decoder_inputs, decoder_inputs_length)
